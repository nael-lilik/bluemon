...
if __name__ == '__main__':
    appeared_log = set()
    disappeared_log = set()
    previous_devices = {}  # Inisialisasi previous_devices di luar fungsi

    def log_devices_and_update():
        global previous_devices  # Gunakan global untuk mengakses variabel luar
    ...
    def handle_update():
        log_devices_and_update()

    # Membuat tugas penjadwalan untuk pemindaian secara berkala
    socketio.start_background_task(log_devices_and_update)
